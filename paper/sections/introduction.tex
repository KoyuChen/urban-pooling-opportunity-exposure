...
The public results delimit the contribution. Chicago's calendar-disjoint
...
NYC has 125 witness-certified ambiguous decisions among 126 cells, and an
18-cell support lattice closes through 16 cores and 48 buffers. Outcome-blind
non-clique views add ordered worlds but change 0/48 clique-comparison endpoints.
These results support conditional ambiguity and bounded-scale computation, not
an empirical outcome advantage.
