...
The annotated dyad count $q$ is disclosed but membership is hidden, yielding a
cardinality-$q$ matching frontier for mean within-dyad separation. Labels also
...
annotation handling and non-oracle-$q$ checks are in the appendix.
