...
actual fixed-span LP calls from 9,900 to 7,770 (21.5\%).  This isolates a local
causal reduction in pricing work; it is not a rerun of the frozen NYC cohort
or a city-scale runtime result.
\begin{table*}[t]
