...
Model comparisons must hold the query and buffer count fixed; separate maximum
counts change the estimand. Four outcome-blind non-clique views return endpoint
nulls although ordered events add worlds, while thirteen census cells remain
transport-unresolved. Evidence for higher-cardinality ordered events therefore
remains open.
