...
| Projection-to-frontier theorem | One additive frontier agrees iff both ordered exposed faces are hit; every selected-row additive frontier agrees iff the binary projections are equal | Does not cover partition-dependent outcomes or manufacture a post-hoc public query |
